...
export const SUITS: Suit[] = [
  ...
  { id: "classic_repaired", name: "Classic Suit (Repaired)", category: "Base Game", unlock: "Story progression (Act 1)", power: "Web Blossom", powerDesc: "Shoots webs at all nearby enemies." },
  { id: "anti_ock", name: "Anti-Ock Suit", category: "Base Game", unlock: "Story progression (Act 3)", power: "Resupply", powerDesc: "Interlocking nano-plates automatically generate Gadget refills." },
  ...
  { id: "stealth_big_time", name: "Stealth (\"Big Time\") Suit", category: "Base Game", unlock: "Level 23 — 2 Base Tokens, 4 Crime Tokens", power: "Blur Projector", powerDesc: "Creates a stealth field that makes you nearly invisible." },
  ...
  { id: "spider_2099_black", name: "Spider-Man 2099 Black Suit", category: "Base Game", unlock: "Level 36 — 2 Base Tokens, 4 Crime Tokens", power: "Low Gravity", powerDesc: "Greatly lowers gravity for everyone." },
  ...
  { id: "last_stand", name: "Last Stand Suit", category: "Base Game", unlock: "Level 45 — 20 Crime Tokens", power: "Unrelenting Fury", powerDesc: "Enemies cannot block your attacks, even if they have shields." },
  ...
  { id: "spider_armor_mk4", name: "Spider-Armor MK IV Suit", category: "Base Game", unlock: "Level 50 — all skill points spent", power: "Defense Shield", powerDesc: "Interlocking nano-plates create an energy shield." },
